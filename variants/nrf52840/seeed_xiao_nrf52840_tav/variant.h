#ifndef _SEEED_XIAO_NRF52840_TAV_H_
#define _SEEED_XIAO_NRF52840_TAV_H_
...
/*
 * On-board LSM6DS3TR-C IMU pins
 */
#define IMU_INT1_PIN (18) // D18 = P0.11 (6D_INT1)
#define IMU_PWR_PIN (15)  // D15 = P1.08 (6D_PWR)
#define IMU_SDA_PIN (17)  // D17 = P0.07 (6D_I2C_SDA)
#define IMU_SCL_PIN (16)  // D16 = P0.27 (6D_I2C_SCL)

/*
 * IMU-based motion detection
 * IMU is on Wire1 (BSP provides it for xiao_ble_sense board).
 * Wire0 is left on NFC pins to keep the Meshtastic I2C scan safe.
 */
#define HAS_IMU_DETECTION 1
...
/*
 * GPS — disabled for MD1 (no GNSS module fitted)
 * Future variants (e.g. AT1 Asset Tracker) can re-enable these defines.
 */
// #define GPS_L76K
...
// Serial1 pins required by Arduino framework even without GPS
// (-1) is the established pattern for "no UART" — same as PIN_SERIAL2_RX/TX above
...
#define SKIP_WIRE1_SCAN 1       // IMU must be powered on before Wire1 scan; skip auto-scan

// Wire0: NFC pins (unused on MD1, but prevents scan hang)
#define PIN_WIRE_SDA 30
#define PIN_WIRE_SCL 31

// Wire1: Internal LSM6DS3TR-C IMU
#define PIN_WIRE1_SDA IMU_SDA_PIN
#define PIN_WIRE1_SCL IMU_SCL_PIN
